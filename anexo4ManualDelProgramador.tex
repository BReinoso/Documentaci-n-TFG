...
Primero debemos elegir la primera opción de la primera imagen y después aceptar la licencia de la segunda imagen en el paso 1 (\ref{mat1}). 
...
\begin{lstlisting}[frame=none,language=bash,caption={Solución al error de CUDA},basicstyle=\large,label={lst:se}]
