...
Este proyecto tiene como objetivo el estudio teórico de herramientas de \textit{machine learning}. Las herramientas que se quieren estudiar tendrán como funcionalidad el tratamiento de imágenes y la extracción de una predicción a partir de estas.
